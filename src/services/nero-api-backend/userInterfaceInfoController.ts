...
export async function getUserInterfaceInfoVOByIdUsingGET(
    ...
    return request<API.BaseResponseUserInterfaceInfo_>('/api/userInterfaceInfo/get/vo', {
        method: 'GET',
        params: {
            ...params,
        },
...
/** checkUserHasInterface GET /api/userInterfaceInfo/has/vo */
export async function checkUserHasInterfaceUsingGET(
    // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
    params: API.checkUserHasInterfaceUsingGETParams,
    options?: { [key: string]: any },
) {
    return request<API.BaseResponseUserInterfaceInfo_>('/api/userInterfaceInfo/has/vo', {
        method: 'GET',
        params: {
            ...params,
        },
...
export async function listUserInterfaceInfoVOByPageUsingPOST(
    ...
    return request<API.BaseResponsePageUserInterfaceInfo_>('/api/userInterfaceInfo/list/page/vo', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
